...
<head>
    ...
    <title>Home | HH MVC Framework</title>
...
<body class="d-flex h-100 text-center text-white bg-dark">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main class="px-3">
            ...
            <h1>Welcome to @HH Framework</h1>
            <p class="lead">@HH is a PHP-based MVC Framework.</p>
            <!-- <p class="lead">
        ...
        <footer class="mt-auto text-white-50">
            <p>Template by <a href="https://getbootstrap.com/" class="text-white">Bootstrap</a></p>
        </footer>
    </div>
